...
// This is the reciprocal of the maximum depth range. It is currently set to 1 / 10.0 meters.
// This constant must be updated if the maximum depth range of the depth camera is changed.
// not ideal, but no way to set fx paramaters from sim through standard routes
#define invDepthRange 0.1

// Minimum and Maximum range of the sensor
#define MinimumRangeMM 500.0
#define MaximumRangeMM 10000.0
              ...
              ) : COLOR
{
    ...
    {
        outColor = (-dot(Pos - eyePos, float3(viewMatrix[0][2], viewMatrix[1][2], viewMatrix[2][2]) ) * invDepthRange).xxxx;
        outColor.a = 1.0;
