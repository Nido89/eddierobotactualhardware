...
using user = Microsoft.Robotics.Services.WebCamSensor.Proxy;
using roboticsUser = Microsoft.Robotics.Services.Sample.BlobTrackerCalibrate.Proxy;
using drive = Microsoft.Robotics.Services.Drive.Proxy;

namespace Robotics.FindObject.Diagram
{
    ...
    public class DiagramService : dssm.DsspServiceBase
    {
        ...
        [dssa.ServicePort("/FindObject", AllowMultipleInstances = true)]
        ...
        // Partner: UserBlobTrackerCalibrate, Contract: http://schemas.microsoft.com/robotics/2007/04/blobtrackercalibrate.user.html
        [dssa.Partner("UserBlobTrackerCalibrate", Contract = roboticsUser.Contract.Identifier, CreationPolicy = dssa.PartnerCreationPolicy.UsePartnerListEntry)]
        roboticsUser.BlobTrackerCalibrateOperations _userBlobTrackerCalibratePort = new roboticsUser.BlobTrackerCalibrateOperations();

        // Partner: UserKinect, Contract: http://schemas.microsoft.com/robotics/2011/01/webcamsensor.user.html
        [dssa.Partner("UserKinect", Contract = user.Contract.Identifier, CreationPolicy = dssa.PartnerCreationPolicy.UsePartnerListEntry)]
        user.WebCamSensorOperations _userKinectPort = new user.WebCamSensorOperations();
        ...
        class StartHandler : HandlerBase
        {
            ...
            // snippet.element
            // __use__.snippet.call - __use__.snippet.call.iftype
            // __use__2.snippet0.call - __use__2.snippet0.call.iftype
            // expr - get - if if{__use__1.snippet0.snippet.noop - [(__use__1.snippet0.snippet.expr0 - __use__1.snippet0.snippet.join)(__use__1.snippet0.snippet.expr - &__use__1.snippet0.snippet.join)] - __use__1.snippet0.call - __use__1.snippet0.call.iftype}elseif{__use__10.snippet0.snippet.noop - [(__use__10.snippet0.snippet.expr0 - __use__10.snippet0.snippet.join)(__use__10.snippet0.snippet.expr - &__use__10.snippet0.snippet.join)] - __use__10.snippet0.call - __use__10.snippet0.call.iftype}else{__use__11.snippet0.snippet.noop - [(__use__11.snippet0.snippet.expr0 - __use__11.snippet0.snippet.join)(__use__11.snippet0.snippet.expr - &__use__11.snippet0.snippet.join)] - __use__11.snippet0.call - __use__11.snippet0.call.iftype}
            ///////////////////////////////////////////////////////////////////
            ...
            public IEnumerator<ccr.ITask> RunHandler()
            {
                ...
                Activate(
                    ccr.Arbiter.Choice(
                        UserKinectPort.Get(new dssp.GetRequestType()),
                        OnGetRequestTypeSuccess,
                        delegate(soap.Fault fault)
                        {
                            base.FaultHandler(fault, @"UserKinectPort.Get(new dssp.GetRequestType())");
                            Decrement();
                        }
                    )
                );
            ...
            void OnGetRequestTypeSuccess(Microsoft.Robotics.Services.WebCamSensor.WebCamSensorState response)
            {

                Increment();
                Activate(
                    ccr.Arbiter.Choice(
                        UserBlobTrackerCalibratePort.Get(new dssp.GetRequestType()),
                        OnGetRequestType1Success,
                        delegate(soap.Fault fault)
                        {
                            base.FaultHandler(fault, @"UserBlobTrackerCalibratePort.Get(new dssp.GetRequestType())");
                            Decrement();
                        }
                    )
                );
        ...
        class HandlerBase : ccr.CcrServiceBase
        {
            ...
            protected roboticsUser.BlobTrackerCalibrateOperations UserBlobTrackerCalibratePort
            {
                get { return _service._userBlobTrackerCalibratePort; }
            }

            protected user.WebCamSensorOperations UserKinectPort
            {
