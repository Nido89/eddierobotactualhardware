...
namespace Microsoft.Robotics.Services.Drive
{
    ...
    /// </summary>
    [DisplayName("(User) Generic Differential Drive")]
    ...
    public class DriveDifferentialTwoWheel : DsspServiceBase
    {
        ...
        const string _transform = ServicePaths.EmbeddedResources + "/RoboticsCommon" +"/Microsoft.Robotics.Drive.user.xslt";
