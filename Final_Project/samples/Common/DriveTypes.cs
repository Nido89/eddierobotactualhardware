...
//
//  $File: DriveTypes.cs $ $Revision: 30 $
//-----------------------------------------------------------------------
...
namespace Microsoft.Robotics.Services.Drive
{
    ...
    public class DriveOperations : PortSet
    {
        ...
        public static implicit operator Port<ResetEncoders>(DriveOperations portSet)
        {
            if (portSet == null)
            {
                return null;
            ...
            return (Port<ResetEncoders>)portSet[typeof(ResetEncoders)];
        }
    ...
    /// Resets encoders
    /// </summary>
    [Description("Resets the encoders.")]
    public class ResetEncoders : Update<ResetEncodersRequest, PortSet<DefaultUpdateResponseType, Fault>>
    {
        /// <summary>
        ...
        {
            this.Body = new ResetEncodersRequest();
        }
    }
