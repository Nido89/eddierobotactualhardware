//------------------------------------------------------------------------------
//  <copyright file="SpeechRecognizerTypes.cs" company="Microsoft Corporation">
...
namespace Microsoft.Robotics.Services.Sensors.Kinect.MicArraySpeechRecognizer
{
    ...
    /// </summary>
    public class BeamDirectionChanged : Update<BeamDirectionChangedNotification, PortSet<DefaultUpdateResponseType, Fault>>
    {
    }
