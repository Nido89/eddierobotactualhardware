...
//
//  $File: HiTechnicCompassSensor.cs $ $Revision: 22 $
//-----------------------------------------------------------------------
...
namespace Microsoft.Robotics.Services.Sample.HiTechnic.Compass
{
    ...
    [Description("Provides access to the HiTechnic Compass Sensor.\n(for use with 'Lego NXT Brick (v2)' service)")]
    [DisplayName("(User) HiTechnic Compass Sensor")]
    [DssServiceDescription("http://msdn.microsoft.com/library/bb663559.aspx")]
    [DssCategory(pxbrick.LegoCategories.NXT)]
    public class HiTechnicCompassSensor : DsspServiceBase
    {
        /// <summary>
        /// _state
        /// </summary>
        [InitialStatePartner(Optional = true, ServiceUri = ServicePaths.Store + "/HiTechnic.Nxt.Compass.config.xml")]
        ...
        /// _main Port
        /// </summary>
        [ServicePort("/hitechnic/nxt/compass", AllowMultipleInstances = true)]
        ...
        [EmbeddedResource("Microsoft.Robotics.Services.Sample.HiTechnic.Transforms.Compass.user.xslt")]
        ...
        /// </summary>
        public HiTechnicCompassSensor(DsspServiceCreationPort creationPort) : 
                base(creationPort)
        {
        }
