...
namespace Microsoft.Robotics.Services.Simulation.Sensors.SimulatedKinect
{
    ...
    public partial class SimulatedKinect : DsspServiceBase
    {
        ...
        /// </summary>
        /// <param name="rotate">Self explanatory</param>
        ...
        {
            SubscribeHelper(this.kinectSubmgrPort, subscribe, subscribe.ResponsePort);
        }
            ...
            var panTiltState = new pantilt.PanTiltState
            {
                ...
                TiltState = new saj.SingleAxisJointState
                {
                    ...
                    JointInformation = new saj.JointInformation
                    {
                        ...
                        MinimumRotationAngleInRadians = (double)kinect.KinectReservedSampleValues.MinimumTiltAngle / DegreesPerRadian,
                        MaximumRotationAngleInRadians = (double)kinect.KinectReservedSampleValues.MaximumTiltAngle / DegreesPerRadian
                    }
                }
            };
        ...
        /// <summary>
        /// Update the tile angle.
        /// </summary>
        /// <param name="rotationAngleDegrees">Angle to update to.</param>
        private void UpdateTiltAngle(double rotationAngleDegrees)
        {
            ...
            SendNotification(this.kinectSubmgrPort, rotate);
        }
    }
}
