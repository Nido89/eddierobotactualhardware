...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ps="http://schemas.microsoft.com/robotics/2011/08/kinect.user.html">
      ...
      <xsl:with-param name="head">
        ...
        <script language="javascript" type="text/javascript">
          <xsl:comment>
            <![CDATA[
var refreshTime = 250;
var targetUrl = self.location.href + "/depthcam?type=depthplusrgb";
    ...
    <table>
      ...
      <tr class="even">
        <td colspan="2" align="center">
          <img id="TargetImg" name="TargetImg" src="." alt="Depth Camera Image" onload="onImageLoad()" onerror="onImageError()" />
        </td>
      </tr>
      <tr class="odd">
        <th>
      ...
      <tr class="odd">
        ...
        <td>
          <select name="Format" onchange="targetUrl = self.location.href + '/depthcam' + this.value; loadImage();">
            ...
            <option value="?type=ir">Ir</option>
          </select>
        </td>
      </tr>
      <tr class="even">
      ...
      <tr class="even">
        ...
        <td>
          <form method="POST" style="display:inline">
            ...
            <input type="hidden" Name="DsspOperationBodyType" Value="Microsoft.Robotics.Services.Sensors.Kinect.Proxy.UpdateTiltRequest" />
