...
//
//  $File: jointmoverui.cs $ $Revision: 10 $
//-----------------------------------------------------------------------
    ...
    public partial class SimulatedBipedMoverUI : Form
    {
        ...
        public void AddSliders(Dictionary<string,DOFDesc> joints)
        {
            ...
            foreach (DOFDesc desc in joints.Values)
            {
                ...
                tb.Maximum = (int)(desc.Maximum * desc.Scale);
                tb.Minimum = (int)(desc.Minimum * desc.Scale);
                tb.Value = (int)(desc.DefaultDriveValue * desc.Scale);
                tb.Name = desc.Name;
                tb.Size = new System.Drawing.Size(800 - labelWidth, 45);
                tb.TabIndex = 0;
                tb.TickFrequency = 3;
